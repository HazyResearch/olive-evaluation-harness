...
class NeoxLMDataModuleConfig(DataModuleConfig):
    target: str = "train.datamodules.language_modeling_neox.NeoxLMDataModule"
    ...
    train_datapath: str="/var/cr06_data/sim_data/pile/pile/pile_text_document"
    valid_datapath: str="/var/cr06_data/sim_data/pile/pile_validation/pile_validation_text_document"
    test_datapath: str="/var/cr06_data/sim_data/pile/pile_test/pile_test_text_document"
...
class NeoxLMDataModule(LightningDataModule):
    def __init__(self, 
        ...
        **kwargs
        ...
        self.train_datapath = config.train_datapath
        self.valid_datapath = config.valid_datapath
        self.test_datapath = config.test_datapath
